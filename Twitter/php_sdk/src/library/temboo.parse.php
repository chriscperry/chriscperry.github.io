 ...
 * @subpackage Parse
 */
class Parse_Objects_RetrievePropertyValue extends Temboo_Choreography
{
    /**
     * Retrieves the value for a given property contained within an object.
     *
     * @param Temboo_Session $session The session that owns this RetrievePropertyValue Choreo.
     * @return Parse_Objects_RetrievePropertyValue New instance.
     */
    public function __construct(Temboo_Session $session)
    {
        parent::__construct($session, '/Library/Parse/Objects/RetrievePropertyValue/');
    }

    /**
     * Executes this Choreo.
     *
     * Execution object provides access to results appropriate for this RetrievePropertyValue Choreo.
     *
     * @param Parse_Objects_RetrievePropertyValue_Inputs|array $inputs (optional) Inputs as Parse_Objects_RetrievePropertyValue_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
     * @return Parse_Objects_RetrievePropertyValue_Execution New execution object.
     * @throws Temboo_Exception_Authentication if session authentication fails.
     * @throws Temboo_Exception_Execution if runtime errors occur in synchronous execution or execution fails to start. NOT thrown for post-launch errors in asynchronous execution -- check status or results to determine asynchronous success.
     * @throws Temboo_Exception_Notfound if choreography does not exist.
     * @throws Temboo_Exception if execution request fails.
    ...
    public function execute($inputs = array(), $async = false, $store_results = true)
    {
        return new Parse_Objects_RetrievePropertyValue_Execution($this->session, $this, $inputs, $async, $store_results);
    }

    /**
     * Obtains a new inputs object.
     *
     * Includes setters appropriate for this RetrievePropertyValue Choreo.
     *
     * @param array $inputs (optional) Associative array of input names and values.
     * @return Parse_Objects_RetrievePropertyValue_Inputs New inputs object.
     * @throws Temboo_Exception if provided input set is invalid. (Note an empty set is considered valid.)
     */
    public function newInputs($inputs = array())
    {
        return new Parse_Objects_RetrievePropertyValue_Inputs($inputs);
    }
}


/**
 * Inputs object with appropriate setters for the RetrievePropertyValue Choreo.
 *
 * @package Temboo
 * @subpackage Parse
 */
class Parse_Objects_RetrievePropertyValue_Inputs extends Temboo_Inputs
{
   /**
     * Inputs object with appropriate setters for the RetrievePropertyValue Choreo.
     *
     * @param array $inputs (optional) Associative array of input names and values.
     * @return Parse_Objects_RetrievePropertyValue_Inputs New instance.
     * @throws Temboo_Exception if provided input set is invalid. (Note an empty set is considered valid.)
     */
    public function __construct($inputs = array())
    {
    ...
    /**
     * Set arbitrary input this RetrievePropertyValue input set.
     *
     * Input names are case sensitive.
     *
     * @param string $name Input name.
     * @param string $value Input value.
     * @return Parse_Objects_RetrievePropertyValue_Inputs For method chaining.
     */
    public function set($name, $value)
    {
        return parent::set($name, $value);
    ...
    /**
     * Set the value for the ApplicationID input for this RetrievePropertyValue Choreo.
     *
     * @param string $value (required, string) The Application ID provided by Parse.
     * @return Parse_Objects_RetrievePropertyValue_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the ClassName input for this RetrievePropertyValue Choreo.
     *
     * @param string $value (required, string) The class name for the object being retrieved.
     * @return Parse_Objects_RetrievePropertyValue_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the ObjectID input for this RetrievePropertyValue Choreo.
     *
     * @param string $value (required, string) The ID of the object to retrieve.
     * @return Parse_Objects_RetrievePropertyValue_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the PropertyName input for this RetrievePropertyValue Choreo.
     *
     * @param string $value (required, string) The name of the property to return.
     * @return Parse_Objects_RetrievePropertyValue_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the RESTAPIKey input for this RetrievePropertyValue Choreo.
     *
     * @param string $value (required, string) The REST API Key provided by Parse.
     * @return Parse_Objects_RetrievePropertyValue_Inputs For method chaining.
     */
...
/**
 * Execution object for the RetrievePropertyValue Choreo.
 *
 * @package Temboo
 * @subpackage Parse
 */
class Parse_Objects_RetrievePropertyValue_Execution extends Temboo_Choreography_Execution
{
    /**
     * Execution object for the RetrievePropertyValue Choreo.
     *
     * @param Temboo_Session $session The session that owns this RetrievePropertyValue execution.
     * @param Parse_Objects_RetrievePropertyValue $choreo The choreography object for this execution.
     * @param Parse_Objects_RetrievePropertyValue_Inputs|array $inputs (optional) Inputs as Parse_Objects_RetrievePropertyValue_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
     * @return Parse_Objects_RetrievePropertyValue_Execution New execution.
     * @throws Temboo_Exception_Authentication if session authentication fails.
     * @throws Temboo_Exception_Execution if runtime errors occur in synchronous execution or execution fails to start. NOT thrown for post-launch errors in asynchronous execution -- check status or results to determine asynchronous success.
     * @throws Temboo_Exception_Notfound if choreography does not exist.
     */
    public function __construct(Temboo_Session $session, Parse_Objects_RetrievePropertyValue $choreo, $inputs = array(), $async = false, $store_results = true)
    {
        parent::__construct($session, $choreo, $inputs, $async, $store_results);
    }
     ...
     * Obtains a new results object.
     *
     * Includes getters appropriate for this RetrievePropertyValue execution.
     *
     * @return Parse_Objects_RetrievePropertyValue_Results New results object.
     * @throws Temboo_Exception_Authentication if session authentication fails.
     * @throws Temboo_Exception_Execution if runtime errors occurred in asynchronous execution.
     * @throws Temboo_Exception_Notfound if execution does not exist.
     * @throws Temboo_Exception if result request fails.
    ...
    /**
     * Wraps results in appropriate results class for this RetrievePropertyValue execution.
     *
     * @param array $outputs Associative array of output names and values.
     * @return Parse_Objects_RetrievePropertyValue_Results New results object.
     */
    protected function wrapResults($outputs)
    {
        return new Parse_Objects_RetrievePropertyValue_Results($outputs);
    }
}


/**
 * Results object with appropriate getters for the RetrievePropertyValue Choreo.
 *
 * @package Temboo
 * @subpackage Parse
 */
class Parse_Objects_RetrievePropertyValue_Results extends Temboo_Results
{
    /**
     * Results object with appropriate getters for the RetrievePropertyValue Choreo.
     *
     * @param array $outputs (optional) Associative array of output names and values.
     * @return Parse_Objects_RetrievePropertyValue_Results New instance.
     * @throws Temboo_Exception if provided output set is invalid. (Note an empty set is considered valid.)
     */
    public function __construct($outputs = array())
    {
    ...
    /**
     * Retrieve the value for the "Value" output from this RetrievePropertyValue execution.
     *
     * @return string (string) The value of the specified property.
     * @throws Temboo_Exception_Notfound if output does not exist. (Note an empty response is considered valid.)
     */
...
class Parse_Queries_Query_Inputs extends Temboo_Inputs
{
   /**
    ...
    /**
     * Set the value for the Keys input for this Query Choreo.
     *
     * @param string $value (optional, string) Limits the number of fields returned in the response to the fields names specificed in this comma-separated list. Special fields such as objectId, createdAt, and updatedAt will still be returned.
     * @return Parse_Queries_Query_Inputs For method chaining.
     */
     ...
     *
     * @param string $value (optional, string) Specifies a field to sort by. Prefixing with a negative sign reverses the order (e.g., -created_at).
     * @return Parse_Queries_Query_Inputs For method chaining.
     */
