...
class Nexmo_SMS_SendMessage_Inputs extends Temboo_Inputs
{
   /**
     ...
     *
     * @param string $value (required, string) The phone number associated with your Nexmo account e.g. 17185551234.
     * @return Nexmo_SMS_SendMessage_Inputs For method chaining.
     */
     ...
     *
     * @param string $value (required, string) The mobile number in international format (e.g. 447525856424 or 00447525856424 when sending to UK).
     * @return Nexmo_SMS_SendMessage_Inputs For method chaining.
     */
...
class Nexmo_Voice_CaptureTextToSpeechPrompt_Inputs extends Temboo_Inputs
{
   /**
    ...
    /**
     * Set the value for the CallbackMethod input for this CaptureTextToSpeechPrompt Choreo.
     *
     * @param string $value (optional, string) The HTTP method for your callback. Valid values are: GET (default) or POST.
     * @return Nexmo_Voice_CaptureTextToSpeechPrompt_Inputs For method chaining.
     */
     ...
     *
     * @param string $value (optional, string) A CallbackURL that Nexmo will request when the call ends to notify your application.  If left empty, the Choreo will handle the callback for you and return the results in CallbackData.
     * @return Nexmo_Voice_CaptureTextToSpeechPrompt_Inputs For method chaining.
     */
    public function setCallbackURL($value)
    {
    ...
    /**
     * Set the value for the From input for this CaptureTextToSpeechPrompt Choreo.
     *
     * @param string $value (optional, string) A voice enabled inbound number associated with your Nexmo account.
     * @return Nexmo_Voice_CaptureTextToSpeechPrompt_Inputs For method chaining.
     */
    public function setFrom($value)
    {
    ...
    /**
     * Set the value for the MachineDetection input for this CaptureTextToSpeechPrompt Choreo.
     *
     * @param string $value (optional, string) If set to "hangup", the call will hang up immediately if a machine is detected, and the status in the CallbackData output will be set to "machine".
     * @return Nexmo_Voice_CaptureTextToSpeechPrompt_Inputs For method chaining.
     */
    public function setMachineDetection($value)
    {
        return $this->set('MachineDetection', $value);
    }

    /**
     * Set the value for the MachineTimeout input for this CaptureTextToSpeechPrompt Choreo.
     *
     * @param int $value (optional, integer) Time allocated to analyze if the call has been answered by a machine. The default value is 15000 (milliseconds).
     * @return Nexmo_Voice_CaptureTextToSpeechPrompt_Inputs For method chaining.
     */
    public function setMachineTimeout($value)
    {
        return $this->set('MachineTimeout', $value);
    }

    /**
     * Set the value for the MaxDigits input for this CaptureTextToSpeechPrompt Choreo.
     *
     * @param int $value (conditional, integer) Number of digits entered by the end user. Valid values are 1-9. Defaults to 1.
     * @return Nexmo_Voice_CaptureTextToSpeechPrompt_Inputs For method chaining.
     */
...
class Nexmo_Voice_CaptureTextToSpeechPrompt_Results extends Temboo_Results
{
    ...
    /**
     * Retrieve the value for the "Digits" output from this CaptureTextToSpeechPrompt execution.
     *
     * @return int (integer) The digits that the call recipient entered into the keypad after receiving the call from Nexmo.
     * @throws Temboo_Exception_Notfound if output does not exist. (Note an empty response is considered valid.)
     */
...
class Nexmo_Voice_ConfirmTextToSpeechPrompt_Inputs extends Temboo_Inputs
{
   /**
    ...
    /**
     * Set the value for the CallbackMethod input for this ConfirmTextToSpeechPrompt Choreo.
     *
     * @param string $value (optional, string) The HTTP method for your callback. Valid values are: GET (default) or POST.
     * @return Nexmo_Voice_ConfirmTextToSpeechPrompt_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the From input for this ConfirmTextToSpeechPrompt Choreo.
     *
     * @param string $value (optional, string) A voice enabled inbound number associated with your Nexmo account.
     * @return Nexmo_Voice_ConfirmTextToSpeechPrompt_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the MachineDetection input for this ConfirmTextToSpeechPrompt Choreo.
     *
     * @param string $value (optional, string) If set to "hangup", the call will hang up immediately if a machine is detected, and the status in the CallbackData output will be set to "machine".
     * @return Nexmo_Voice_ConfirmTextToSpeechPrompt_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the MachineTimeout input for this ConfirmTextToSpeechPrompt Choreo.
     *
     * @param int $value (optional, integer) Time allocated to analyze if the call has been answered by a machine. The default value is 15000 (milliseconds).
     * @return Nexmo_Voice_ConfirmTextToSpeechPrompt_Inputs For method chaining.
     */
...
class Nexmo_Voice_TextToSpeech_Inputs extends Temboo_Inputs
{
   /**
    ...
    /**
     * Set the value for the From input for this TextToSpeech Choreo.
     *
     * @param string $value (optional, string) A voice enabled inbound number associated with your Nexmo account.
     * @return Nexmo_Voice_TextToSpeech_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the MachineDetection input for this TextToSpeech Choreo.
     *
     * @param string $value (optional, string) If set to "hangup", the call will hang up immediately if a machine is detected, and the status in the CallbackData output will be set to "machine".
     * @return Nexmo_Voice_TextToSpeech_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the MachineTimeout input for this TextToSpeech Choreo.
     *
     * @param int $value (optional, integer) Time allocated to analyze if the call has been answered by a machine. The default value is 15000 (milliseconds).
     * @return Nexmo_Voice_TextToSpeech_Inputs For method chaining.
     */
